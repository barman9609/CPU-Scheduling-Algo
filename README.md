# CPU-Scheduling-Algo
Implementation of various CPU scheduling algorithms in C++. The algorithms included are First Come First Serve (FCFS), Round Robin (RR), Shortest Process Next (SPN), Shortest Remaining Time (SRT), Highest Response Ratio Next (HRRN), Feedback (FB) and Aging.

## Table of Contents
- [CPU-Scheduling-Algorithms](#CPU-Scheduling-Algo)
...
> Check the attached [testcases](https://github.com/barman9609/CPU-Scheduling-Algo/tree/main/Testcases) for more details.
## Reference

- [Repo](https://github.com/yousefkotp/CPU-Scheduling-Algorithms/tree/main)
